...
df = pd.read_csv('C:/Users/noturno/Desktop/Miron Python 2/Python 22/python02-main/python02-main/sistema/drinks.csv')
...
html_template = '''
    ...
    <h2> Parte 2 </h2>
        <ul>
            ...
            <li><a href="/upload_avegers"> Upload do CSV </a></li>
            <li><a href="/apagar_avegers"> Apagar Tabela Avenger </a></li>
            <li><a href="/atribuir_paises_avengers"> Atribir Paises </a></li>
